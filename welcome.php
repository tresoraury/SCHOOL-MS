            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">HILL SCHOOL</h1>
	                        <p class="hero-paragraph">Choose between these links bellow</p>
	                        <div class="hero-cta">
                                <a href="index.php" class="btn btn-primary btn-lg btn-space">MANAGE STUDENTS</a>
                                <a href="index2.php" class="btn btn-secondary btn-lg btn-sapce">MANAGE TEACHERS</a>
                            </div>
						</div>
						<div class="hero-app">
                ...
                <div class="container-sm">
                    <div class="newsletter-inner section-inner">
                        <div class="newsletter-header text-center">
                            <h2 class="section-title mt-0">Stay in School kids</h2>
                            <p class="section-paragraph">Best tool to manage a School</p>
                        </div>
                        <div class="footer-form newsletter-form field field-grouped">
                            <div class="control control-expanded">
                                ...
                                <a class="btn btn-primary btn-lg btn-space" href="#">Send Email</a>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  <footer class="site-footer">
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    ...
                    <div class="cp-text">&copy; AURY TRESOR</div>
                </div>
            </div>
        </footer>
  </body>
